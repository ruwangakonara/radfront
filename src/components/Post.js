    ...
    return (
        <div>
            ...
            <form onSubmit={(event) => handleUpdatePost(event)}>
                ...
                <input type="text" name="coursename" placeholder="Course Name" value={updatedCoursename} onChange={(event) => setUpdatedCoursename(event.target.value)}/><br></br>
                <input type="text" name="unitname" placeholder="Unit Name" value={updatedUnitname} onChange={(event) => setUpdatedUnitname(event.target.value)}/><br></br>
                <textarea name="description" placeholder="Description" value={updatedDescription} onChange={(event) => setUpdatedDescription(event.target.value)}/><br></br>
                <input type="file" name="image" accept="image/*" onChange={(event) => handleImageChange(event)}/><br></br>
